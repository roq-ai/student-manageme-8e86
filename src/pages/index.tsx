  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Student Management System - a software designed to revolutionize the way school authorities and students interact, making education management seamless and efficient."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1543269865-cbf427effbad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdHVkZW50c3xlbnwwfHx8fDE2OTg0MTIyNzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Student Management System - a software designed to revolutionize the way school authorities and students interact, making education management seamless and efficient.`}
            </Text>
            <Box
