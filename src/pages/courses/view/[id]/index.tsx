...
import { useCourseFindFirst, useRoqClient } from 'lib/roq';
...
function CourseViewPage() {
  ...
  const queryParams = useMemo<{ include: { school: boolean; teacher: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useCourseFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Credits" text={data?.credits} />
