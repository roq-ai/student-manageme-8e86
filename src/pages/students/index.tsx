...
export function StudentListPage(props: StudentListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['grade_level.contains', 'major.contains'],
          ...params.filters,
        },
        'student',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'grade_level', header: 'Grade Level', accessorKey: 'grade_level' },
    {
      id: 'enrollment_date',
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.graduation_date ? format(record?.graduation_date, 'dd-MM-yyyy') : '',
    },
    { id: 'major', header: 'Major', accessorKey: 'major' },
