...
import { useRoqClient, useParentFindManyWithCount } from 'lib/roq';
...
export function ParentListPage(props: ParentListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useParentFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.parent.delete({ where: { id } });
      await mutate();
    } catch (error) {
