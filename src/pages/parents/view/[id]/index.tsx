...
import { useParentFindFirst, useRoqClient } from 'lib/roq';
...
function ParentViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; student: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useParentFindFirst(queryParams, {}, { disabled: !id });
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Relationship" text={data?.relationship} />
