...
export function useParentFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useParentFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.parent.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParentCount<T extends Prisma.parentCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.parentCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useParentCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.parent.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParentFindManyWithCount<
  T extends Prisma.parentFindManyArgs,
  R extends { data: GetFindResult<Prisma.$parentPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.parentFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useParentFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.parent.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParentFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useParentFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.parent.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
